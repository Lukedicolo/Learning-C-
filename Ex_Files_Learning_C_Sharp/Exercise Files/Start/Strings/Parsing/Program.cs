    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try {
                ...
                Console.WriteLine($"Integer: {targetNum}");
                ...
                Console.WriteLine($"Thousands AND decimal: {targetNum}");
            ...
            // Try parsing a currency string.
            string numStr5 = "£69.50";
            bool success = false;
            decimal targetNum2 = 0;
            
            success = Decimal.TryParse(numStr5, NumberStyles.Currency, CultureInfo.CurrentCulture, out targetNum2);

            if (success) {
                Console.WriteLine($"{targetNum2}");
            }
        }
    }
}
